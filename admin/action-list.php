    ...
    <div class="container body">
        ...
        <div id="content" class="p-4 ">
                ...
                <div class="row mb-2">
                  <div class="col-sm-12">
                    <ol class="breadcrumb float-right">
                      <li class="breadcrumb-item"><a href="prison-list.php.">Prison List</a></li>
            ...
            <div class="form-group text-center">
                <h3 class="mb-4" style="text-align: center;">Actions Directory</h3>
                <button class="btn float-right btn-primary mb-4" data-toggle="modal" data-target="#addActionModal"><i class="fa fa-plus-circle"></i> Create New</button>
            </div>
        ...
        <input type="hidden" id="type" value="action_list">
        <?php
