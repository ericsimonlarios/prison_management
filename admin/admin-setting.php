            ...
            echo <<<END
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="fName" name="admin_name" value='$admin_name'>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="password" class="form-control" id="lName" name="old_pass">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col">
                        <label for="bno">New Password</label>
                        <input type="password" class="form-control" id="bno" name="new_pass">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col">
                    ...
                    <div class="row mt-3">
                        <div class="form-group col-4">     
                            <input type="submit" class="btn btn-success btn-lg btn-block" id="add" name="edit_admin" value="Save Changes">
                        </div>
                        <div class="form-group col-4">     
                        <input type="submit" class="btn btn-success btn-lg btn-block" id="add" name="redirect_admin" value="Create New Admin">
                        </div>
                    </div>                
                </form>
                END;
