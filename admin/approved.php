...
<body>
    <div class="wrapper">
        ...
        <div id="content" class="p-4 p-md-5 pt-5 ">
            ...
            $con = connect();
            $selectQuery  =  " SELECT * FROM appointment WHERE stats ='Approved'";
            ...
            echo <<< END
            <h3 class="mb-5" style="text-align: center;">Approved Appointment Request</h3>
            END;
            if ($select_rows == 0) {
                echo <<<END
            <div class="container block">
            <span style="font-size:20px;margin:auto;">No Appointments Approved yet</span>
