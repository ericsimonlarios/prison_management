    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="addActionModalLabel">Add New Action</h5>
            ...
            <form class="appointment-form  mt-4" role="alert" method="POST" action="actions.php" style="width: 80%;  margin-left: auto; margin-right: auto;">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="aname" type="text" name="name" placeholder="Name" class="form-control" required>
                    </div>
                ...
                <button type="submit" class="btn btn-primary" name="action-submit">Add</button>
                </div>
